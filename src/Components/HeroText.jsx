...
const HeroText = () => {
  const name = "PAU ARBAT I JUBINYÀ";
  ...
  return (
    ...
    >
      <LazyMotion features={domAnimation} strict>
        ...
        >
        <a href="#about">
          <span className="text-primary-400">Programador Web</span> / Informàtic <span className="text-primary-400">/ Administrador de Xarxa</span>
        </a>
        </m.span>
      </LazyMotion>
    </div>
